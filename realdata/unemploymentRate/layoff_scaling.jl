...
## observation data
applName = "layoff_vix_spread" # all save files with this prefix
...
plt = PlotPostParamEvolution(quant_paramtime,
    "Laplace_$(scalingLabel(scaling))",
    groupSizes; titles=titles, dateVec=dateVec, interpMethod=interpMethod, plot_t0=keep_t0, interval_style=:shaded, lw=1, c=colors[1], legend=:top)
plot(plt...)
...
## Laplace approximation - diagonal scaling
scaling = :diagonal
